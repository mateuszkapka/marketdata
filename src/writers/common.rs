...
pub fn get_normalised_path(_date: &NaiveDate, parser_type: &ParserType) -> String{
    format!("normalised_data/{}.parquet", parser_type)
}

#[allow(dead_code)]
pub fn get_symbology_path(_date: &NaiveDate, parser_type: &ParserType) -> String {
